insert into codigos_postales (codigo_postal, localidad, provincia) values ('24920', 'Aguilar', 'Cordoba');
insert into codigos_postales (codigo_postal, localidad, provincia) values ('24500', 'Montilla', 'Cordoba');
insert into codigos_postales (codigo_postal, localidad, provincia) values ('34800', 'Lucena', 'Cordoba');
insert into codigos_postales (codigo_postal, localidad, provincia) values ('33567', 'Carmona', 'Sevilla');
insert into codigos_postales (codigo_postal, localidad, provincia) values ('33561', 'Lora del Rio', 'Sevilla');
insert into codigos_postales (codigo_postal, localidad, provincia) values ('42123', 'Antequera', 'Malaga');
insert into codigos_postales (codigo_postal, localidad, provincia) values ('43001', 'Campillos', 'Malaga');
insert into codigos_postales (codigo_postal, localidad, provincia) values ('42668', 'Teba', 'Malaga');
insert into codigos_postales (codigo_postal, localidad, provincia) values ('54321', 'Martos', 'Jaen');
insert into codigos_postales (codigo_postal, localidad, provincia) values ('51222', 'Andujar', 'Jaen');

insert into propietarios (nombre, primer_apellido, segundo_apellido, dni, domicilio,codigo_postal_id) values ('Fran', 'Per', 'Vid', '14066899R', 'Calle aaa, 1', 1);
insert into propietarios (nombre, primer_apellido, segundo_apellido, dni, domicilio, codigo_postal_id) values ('Ant', 'Gar', 'Arj', '55000856S', 'Calle bbb, 23', 2);
insert into propietarios (nombre, primer_apellido, segundo_apellido, dni, domicilio, codigo_postal_id) values ('Mig Ang', 'Per', 'Arj', '66009900T', 'Calle ccc, 5', 1);
insert into propietarios (nombre, primer_apellido, segundo_apellido, dni, domicilio, codigo_postal_id) values ('Jos Ant', 'Carr', 'Arj', '11555888V', 'Calle ddd, 76', 3);
insert into propietarios (nombre, primer_apellido, segundo_apellido, dni, domicilio, codigo_postal_id) values ('Alb', 'Lop', 'Arj', '22111552W', 'Calle eee, 8', 2);
insert into propietarios (nombre, primer_apellido, segundo_apellido, dni, domicilio, codigo_postal_id) values ('Raf', 'San', 'Arj', '44000888F', 'Calle fff, 6', 1);
insert into propietarios (nombre, primer_apellido, segundo_apellido, dni, domicilio, codigo_postal_id) values ('Ju', 'Luc', 'ona', '20000111D', 'Calle ggg, 34', 7);
insert into propietarios (nombre, primer_apellido, segundo_apellido, dni, domicilio, codigo_postal_id) values ('Ped', 'Bar', 'rjo', '05667773R', 'Calle hhh, 65', 1);
insert into propietarios (nombre, primer_apellido, segundo_apellido, dni, domicilio, codigo_postal_id) values ('Pab', 'Var', 'na', '77999111G', 'Calle iii, 7', 1);
insert into propietarios (nombre, primer_apellido, segundo_apellido, dni, domicilio, codigo_postal_id) values ('Mar', 'Pe', 'rjon', '88097666Z', 'Calle jjj, 89', 1);

insert into proveedores (nombre, dni_cif, domicilio, codigo_postal_id) values ('GRO EÑAST SL', 'B0000000', 'Peñ Bla, 2', 3);
insert into proveedores (nombre, dni_cif, domicilio, codigo_postal_id) values ('ILLOS LA LAGUNA SL', 'B33000116', 'Calle Armilla, 3', 5);
insert into proveedores (nombre, dni_cif, domicilio, codigo_postal_id) values ('PLAC DE PIEZAS, SL', 'B00999888', 'Las Albarizas, 5', 6);
insert into proveedores (nombre, dni_cif, domicilio, codigo_postal_id) values ('MOT ORDOÑEZ', 'B1118885', 'Calle Bae, 28', 3);
insert into proveedores (nombre, dni_cif, domicilio, codigo_postal_id) values ('COMPONENTES ELOD', 'B09090997', 'Calle cimas, 80', 2);
